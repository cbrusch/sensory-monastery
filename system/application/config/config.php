...
$config['uri_protocol'] = 'ORIG_PATH_INFO'; if (isset($_SERVER['PATH_INFO'])) { $config['uri_protocol'] = 'PATH_INFO';} elseif (isset($_SERVER['ORIG_PATH_INFO']) && stristr($_SERVER['ORIG_PATH_INFO'],'codeigniter.php')) { $config['uri_protocol'] = 'REQUEST_URI';};  
